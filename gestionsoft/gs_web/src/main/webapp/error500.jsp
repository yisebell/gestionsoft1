...
<body>
	<div class="contenidoErrores">
		...
		<h1 class="textoError">Se ha producido un error. Contacte con el administrador</h1>	
		...
		Para ir al inicio de la aplicaci&oacute;n, presione el bot&oacute;n de inicio.</h2>			
	</div>
